...
import DiseasePredictor from "./pages/DiseasePredictor"; // ⬅️ ADD THIS LINE
...
const App = () => (
  <>
    ...
    <Routes>
      ...
      <Route path="/DiseasePredictor" element={<RequireAuth><DiseasePredictor/></RequireAuth>} />
      <Route path="/mental-wellness" element={<RequireAuth><MentalWellness /></RequireAuth>} />
      <Route path="/disease-predictor" element={<RequireAuth><DiseasePredictor /></RequireAuth>} /> {/* ⬅️ ADD THIS LINE */}
